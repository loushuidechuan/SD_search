...
let db_titles = {
    ...
    "Calculate Split Loss": "Splits model loss during training into Instance Loss and Prior Loss. Requires class images to be enabled.",
    ...
    "Generate a .ckpt file when training is canceled.": "When enabled, a checkpoint will be generated when training is canceled by the user.",
    ...
    "Generate lora weights when training is canceled.": "When enabled, lora .pt files will be generated when training is canceled by the user.",
    ...
    "Noise scheduler": "The algorithm used to generate noise used in the diffusion process.",
    ...
    "Save separate diffusers snapshots when training is canceled.": "When enabled, a unique snapshot of the diffusion weights will be saved when training is canceled. This uses more HDD space, but allows resuming from training including the optimizer state.",
    ...
    "ToMeSD": "% of tokens to merge. 0 = disabled. Higher values should improve performance at the cost of reduced quality.",
    ...
    "Use TensorFloat 32": "Probably best to leave this off.",
